...
// DOMPurify очищает HTML и предотвращает атаки XSS. Вы можете передать DOMPurify строку, полную грязного HTML, и он вернет строку (если не настроено иначе) с чистым HTML. 
/**
