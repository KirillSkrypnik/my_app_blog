...
const CartItem = ( {
	...
	return (
		<div className="content_wrap_cart_item">
			<div className="content_wrap_cart_item_image_box">
				<figure >
					<Image
						width="300"
						height="300"
			...
			<div className="content_wrap_cart_item_information_box">
					...
					<div className="cart-product-footer flex justify-between p-4 border-t border-brand-bright-grey">
						<div className="">
